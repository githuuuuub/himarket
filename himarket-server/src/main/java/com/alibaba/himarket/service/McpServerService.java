...
public interface McpServerService {
    ...
    /** 订阅 MCP Server：统一入口，根据参数自动判断直连/沙箱场景 */
    MyEndpointResult subscribe(String productId, SubscribeMcpParam param);

    /** 取消订阅 MCP Server：删除 endpoint，网关来源的还需撤销 consumer 授权 */
    void unsubscribe(String endpointId);
